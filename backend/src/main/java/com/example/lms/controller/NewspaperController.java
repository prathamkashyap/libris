...
@Tag(name = "Newspapers", description = "Catalogue management for newspapers")
public class NewspaperController {
  ...
  public org.springframework.data.domain.Page<NewspaperResponse> list(
  ...
  public NewspaperResponse get(@PathVariable Long id) {
    return service.get(id);
  }

  @PostMapping
  @Operation(summary = "Create a newspaper")
  ...
  public NewspaperResponse update(
      @PathVariable Long id, @Valid @RequestBody NewspaperRequest request) {
  ...
  @ApiResponse(responseCode = "204", description = "Newspaper deleted")
