...
@Tag(name = "Authentication", description = "Session-based login, logout, and CSRF bootstrap")
public class AuthController {
  ...
  @Operation(
      ...
      description =
          "Required before POST requests. Returns a token that must be sent as X-XSRF-TOKEN header.")
  ...
  @Operation(
      ...
      description = "Login with username and password. Creates a session.")
