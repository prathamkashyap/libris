...
import com.example.lms.dto.*; import com.example.lms.entity.Book; import com.example.lms.exception.*; import com.example.lms.repository.*; import com.example.lms.util.StringUtils; import org.springframework.dao.DataIntegrityViolationException; import org.springframework.stereotype.Service; import org.springframework.transaction.annotation.Transactional; import java.util.List;
@Service
public class BookService {
 ...
 @Transactional(readOnly=true) public org.springframework.data.domain.Page<BookResponse> list(String search, org.springframework.data.domain.Pageable pageable){var source=search==null||search.isBlank()?books.findAll(pageable):books.findByTitleContainingIgnoreCaseOrAuthorContainingIgnoreCase(search,search,pageable);return source.map(this::response);}
 ...
 private void apply(Book entity,BookRequest r){entity.setTitle(r.title().trim());entity.setAuthor(StringUtils.blankToNull(r.author()));entity.setIsbn(StringUtils.blankToNull(r.isbn()));entity.setPublishedDate(r.publishedDate());}
