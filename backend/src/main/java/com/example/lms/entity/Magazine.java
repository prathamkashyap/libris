...
public class Magazine extends AuditableEntity {
    ...
    @Column(length=200) private String featuredArticle;
    ...
    public String getFeaturedArticle(){return featuredArticle;} public void setFeaturedArticle(String v){featuredArticle=v;}
